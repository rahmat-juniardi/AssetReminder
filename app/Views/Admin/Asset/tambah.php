...
<div class="d-flex flex-column mx-auto col-lg-6 p-5">
    <div class="h2 mx-auto text-primary mb-4 border-primary" style="border-bottom: 3px solid;">TAMBAH DATA</div>
    <div class="w-100">
        <form action="/home/save" method="post">
            <?= csrf_field(); ?>
            <div class="mb-3">
                <label for="" class="form-label">No Kontrak</label>
                <input type="text" class="form-control" id="" name="no_kontrak">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Jenis Kegiatan</label>
                <input type="text" class="form-control" id="" name="jenis_aset">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="" name="tanggal_mulai">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Tanggal berakhir</label>
                <input type="date" class="form-control" id="" name="tanggal_berakhir">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Saldo</label>
                <input type="number" class="form-control" id="" name="saldo">
            </div>
            <div class="d-flex">
